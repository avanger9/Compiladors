...
void TypeCheckListener::enterMaximExpr(AslParser::MaximExprContext *ctx) {}
void TypeCheckListener::exitMaximExpr(AslParser::MaximExprContext *ctx) {
	putTypeDecor(ctx, getTypeDecor(ctx->maxim()));
	putIsLValueDecor(ctx, getIsLValueDecor(ctx->maxim()));
}

void TypeCheckListener::enterMaxim(AslParser::MaximContext *ctx) {}
void TypeCheckListener::exitMaxim(AslParser::MaximContext *ctx) {
	TypesMgr::TypeId t1 = getTypeDecor(ctx->ident());
...
/*
void TypeCheckListener::enterAlgoExpr(AslParser::AlgoExprContext *ctx) {}
void TypeCheckListener::exitAlgoExpr(AslParser::AlgoExprContext *ctx) {
	putTypeDecor(ctx, getTypeDecor(ctx->algo));
	putIsLValueDecor(ctx, getIsLValueDecor(ctx->algo));
}


void TypeCheckListener::enterAlgo(AslParser::AlgoContext *ctx) {}
void TypeCheckListener::exitAlgo(AslParser::AlgoContext *ctx) {
