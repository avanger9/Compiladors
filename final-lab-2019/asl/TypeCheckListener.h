...
public:
  ...
  // Constructor
    TypeCheckListener(TypesMgr &Types, SymTable &Symbols, TreeDecoration &Decorations, SemErrors &Errors);
    ...
    /*
    void enterAlgoExpr(AslParser::AlgoExprContext *ctx);
    void exitAlgoExpr(AslParser::AlgoExprContext *ctx);
    void enterAlgo(AslParser::AlgoContext *ctx);
    void exitAlgo(AslParser::AlgoContext *ctx);
    */
